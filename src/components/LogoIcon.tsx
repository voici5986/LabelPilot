...
export const LogoIcon: React.FC<LogoIconProps> = ({ className = "", size = 24 }) => {
  return (
    ...
    >
      ...
      <rect 
        x="12" y="6" width="64" height="44" rx="6" 
        fill="currentColor"
      ...
      <rect 
        x="6" y="12" width="64" height="44" rx="6" 
        fill="currentColor"
