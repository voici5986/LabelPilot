...
export const translations = {
  en: {
    ...
    zoom_reset: "Fit to Window",
    zoom_relative_hint:
      "100% fits the page to the window; it is not physical actual size.",
    zoom_actual_hint: "Physical actual size based on screen calibration.",
    ...
    move_image_up: "Move {name} up",
    move_image_down: "Move {name} down",
  ...
  zh: {
    ...
    zoom_reset: "适应窗口",
    zoom_relative_hint: "100% 表示适应窗口，不代表物理实际尺寸。",
    zoom_actual_hint: "根据屏幕校准显示物理实际尺寸。",
    ...
    move_image_up: "将 {name} 上移",
    move_image_down: "将 {name} 下移",
    add_more_images: "继续添加图片",
    zoom_level: "缩放级别",
