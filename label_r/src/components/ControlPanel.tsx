        ...
        <div className="space-y-1.5 hover:-translate-y-0.5 transition-transform duration-200">
            ...
            <div className="relative">
                ...
                <div className="absolute right-0 top-0 h-full flex flex-col border-l border-slate-200">
                    <button onClick={() => value < max && onChange(value + 1)} className="flex-1 px-2 hover:bg-slate-100 text-slate-400 hover:text-indigo-600 rounded-tr-xl flex items-center justify-center">▲</button>
                    <button onClick={() => value > min && onChange(value - 1)} className="flex-1 px-2 hover:bg-slate-100 text-slate-400 hover:text-indigo-600 rounded-br-xl flex items-center justify-center text-[10px]">▼</button>
                </div>
            </div>
        </div>
    );
